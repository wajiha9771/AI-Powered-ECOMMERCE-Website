      ...
      <footer className="site-footer">
        <div className="footer-container">
          <div className="footer-section footer-about">
            ...
            <p>
              Your one-stop destination for premium products. We deliver
              quality, speed, and exceptional customer service worldwide.
            </p>
          ...
          <div className="footer-section footer-contact">
            ...
            <p>
              <span>✆</span> <a href="tel:+923010456997">+92 301 0456997</a>
            </p>
            <p>
              <span>🖂</span>{" "}
              <a href="mailto:misswaji1997@gmail.com">
