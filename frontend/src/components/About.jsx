...
export default function About() {
  return (
    <div className="about-page-wrapper mx-auto max-w-[1200px] px-[15px] py-[30px] md:px-10 md:py-[60px] font-['Poppins',sans-serif] text-[#0f172a]">
      <header className="about-hero mb-[50px] rounded-[20px] p-[10px] text-center">
        <h1 className="about-main-title mb-3 text-[36px] font-extrabold text-[#0a0a0a] md:text-[45px]">
          About Us
        </h1>
        <p className="about-tagline mx-auto max-w-[600px] text-[18px] text-[#5a6a80] md:text-[18px]">
      ...
      <section className="about-content-row mx-auto mb-[60px] max-w-[800px] leading-[1.8]">
        <div className="about-text-block">
          <h2 className="mb-5 text-[32px] font-bold text-[#0a0a0a]">
            The <span className="brand-nex">Nex</span>
            <span className="brand-dash mx-[1px] font-extrabold text-[#0a0a0a]">
              -
            </span>
      ...
      <section className="about-values-grid grid grid-cols-1 gap-[15px] md:grid-cols-3 md:gap-[30px]">
        {/* Card 1 */}
        <div className="value-stat-card rounded-[20px] border border-[#c9c9ca] bg-[rgb(219, 215, 215)]  p-[30px] text-center transition-transform duration-300 ease-in-out hover:-translate-y-[5px]">
          <span className="stat-number mb-[10px] block text-[40px] font-extrabold text-[#333333]">
            100%
          </span>

          <h4 className="mb-[10px] text-[18px] font-bold text-[#111111]">
            Premium Quality
          </h4>
        ...
        {/* Card 3 */}
        <div className="value-stat-card rounded-[20px] border border-[#c9c9ca] bg-[rgba(227, 225, 225, 0.75)]p-[30px] text-center transition-transform duration-300 ease-in-out hover:-translate-y-[5px]">
          <span className="stat-number mb-[10px] block text-[40px] font-extrabold text-[#333333]">
            24/7
          </span>
